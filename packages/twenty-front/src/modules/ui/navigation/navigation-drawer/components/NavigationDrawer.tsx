...
// The sidebar sits on the page ground, as the Stitch screens draw it. The
// hairline on its right is drawn by what it sits against; adding one here put
// two lines side by side at the seam, which Marcus saw on 14 September 2026.
